    ...
    <Fragment>
      ...
      <div className=' absolute w-[80%] top-[30%] md:left-20 lg:left-24 xl:left-32'>
        <section
          ...
          className='max-w-4xl p-6 mx-auto  rounded-md shadow-md dark:bg-gray-800 '>
          ...
          <form>
            ...
            <div className='flex justify-end gap-3 mt-6'>
              <button
                onClick={() => handleShowFromEdit({ status: false })}
                className='px-6 py-2 leading-5 shadow-lg text-white transition-colors duration-200 transform bg-pink-500 rounded-md hover:bg-pink-700 focus:outline-none focus:bg-gray-600'>
                Cancel
              </button>
              <button
                onClick={handleSubmit(editCategory)}
                className='px-6 py-3 leading-5 shadow-lg text-white transition-colors duration-200 transform bg-[#03a9f4] rounded-md hover:bg-[#0691d1] focus:outline-none focus:bg-gray-600'>
                Update
              </button>
            </div>
          </form>
